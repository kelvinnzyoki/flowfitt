...
async function apiRequest(endpoint, options = {}) {
    ...
    // credentials:'include' sends the httpOnly cookie on every cross-origin request
...
async function handleResponse(response) {
    // text()→parse avoids SyntaxError on empty 304 bodies that response.json() would throw
...
// ── WORKOUTS ──────────────────────────────────────────────────────────────────
// Resolves path to '/workouts' or '/exercises' at runtime and caches the result
