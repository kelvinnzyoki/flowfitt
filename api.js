...
function populateSidebarUser() {
    ...
    // Show badge from token immediately (no flicker), then refresh from live API
...
// Fetch live plan from API — keeps sidebar badge in sync with subscription page
async _refreshBadgeFromAPI() {
    try {
        const token = (typeof TokenManager !== 'undefined')
        ...
        // Cancelled/expired → show FREE; trialing → TRIAL; otherwise use plan slug
